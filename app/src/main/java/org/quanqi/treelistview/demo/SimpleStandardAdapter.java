package org.quanqi.treelistview.demo;
...
class SimpleStandardAdapter extends AbstractTreeViewAdapter<Long> {
    ...
    @Override
    public View getNewChildView(TreeNodeInfo<Long> treeNodeInfo, int location, ViewGroup viewGroup) {
        return getNewChildView(treeNodeInfo);
    }

    @Override
    public View updateView(View view, TreeNodeInfo<Long> treeNodeInfo, int location, ViewGroup viewGroup) {
